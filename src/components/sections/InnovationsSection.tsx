          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col px-2 pb-3 pt-0 md:px-3 md:pb-4 md:pt-1 lg:px-5 lg:pb-6 lg:pt-2">
                <h3 className="text-center text-sm leading-snug font-light text-mesocore-gray-900 md:text-title-3 md:leading-[1.2]">
                  {item.name}
                </h3>
                <p className="mt-1.5 text-[0.6875rem] leading-snug text-mesocore-gray-500 md:mt-2 md:text-xs md:leading-relaxed lg:mt-3 lg:text-base">
                  {item.description}
                </p>
              </div>
            </li>
