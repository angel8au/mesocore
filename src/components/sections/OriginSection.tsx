  ...
  return (
    <section className="overflow-hidden bg-primary">
      <Container className="pb-0">
        <div className="grid min-h-[480px] gap-0 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] md:min-h-[520px] md:gap-10 lg:min-h-[560px] lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-16">
          <div className="flex w-full max-w-xl flex-col justify-center pt-12 pb-4 md:max-w-none md:py-12 md:pe-8 lg:py-16 lg:pe-12">
